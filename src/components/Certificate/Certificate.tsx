  ...
  return (
    <li data-testid='CertificateComponent'>
      <Link title='Visualizar certificado' href={link!} target='_blank' className='relative group'>
        ...
        <h3 className='text-neutral-800 dark:text-slate-50 font-medium leading-5 group-hover:translate-x-3 group-hover:text-cyan-950 dark:group-hover:text-green-400 transition'>
          {title}
        </h3>
